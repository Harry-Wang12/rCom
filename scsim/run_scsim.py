...
def parse_args():
    ...
    parser.add_argument('--outdir', type=str, default='./Dataset/randomData/',
...
def main():
    ...
    simulator.counts.to_csv( os.path.join(outdir, 'counts.txt'))
    simulator.cellparams.to_csv( os.path.join(outdir, 'cellparams.txt'))
